...
class DarcyMatrix:
    ...
    def __init__(self, device, n_obj_sample=500, n_constrs=10, n_test_sample=1):
        ...
        """
        # Set problem name
        self.name = 'DarcyMatrix(' + 'n_discretize' + str(self.n_discretize) + ', hidden_channels' + str(
    ...
    def generate_sample(self, device):
        ...
        train_loader, test_loaders, data_processor = load_darcy_flow_small(
            ...
            grid_boundaries=[[0, self.n_discretize / (self.n_discretize - 1)],
                             [0, self.n_discretize / (self.n_discretize - 1)]]  # ensure boundaries are 0 or 1
        )
    ...
    def objective_func_and_grad(self, optimizer, no_grad=False):
        ...
        CHECK THE OBJECTIVE FUNCTION, we got to add the squared 2 norm of c to the objective function
        (making it a penalty method)
        """
    ...
    def constraint_func_and_grad(self, optimizer, no_grad=False):
        ...
        delete everything and set c to zero
        """
